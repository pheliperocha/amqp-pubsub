...
var createProducer = function (options) { return function (exchange, params) { return __awaiter(void 0, void 0, void 0, function () {
    var producerOptions, conn, channel, exchangeName, content, sent, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                producerOptions = __assign(__assign({}, producerDefaultOptions), options);
                return [4 /*yield*/, amqp.connect("amqp://" + producerOptions.username + ":" + producerOptions.password + "@" + producerOptions.host + ":" + producerOptions.port + "/")];
            case 1:
                conn = _a.sent();
            ...
            case 4:
                ...
                sent = channel.publish(exchangeName, '', content, { persistent: true });
                if (!!sent) return [3 /*break*/, 6];
